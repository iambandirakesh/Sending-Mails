...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <p>Best regards,<br>TexxeSchool</p>
  </div>
...
`;
const WELCOME_EMAIL_TEMPLATE = `<!-- Change values in the template and pass { {variables} } with API call -->
            ...
            <tbody>
              <tr>
                <td style="padding:48px 0 30px 0; text-align: center; font-size: 22px; color: #4C83EE; font-weight:bold">
                  Texxe<span style="color:rgb(251 146 60)">School</span>
                </td>
              </tr>
              <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Thanks for choosing TexxeSchool, We are happy to see you on board.
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="font-size: 14px; line-height: 170%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Best regards, <br><strong>TexxeSchool</strong>
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <tr>
                <td style="padding: 24px 0 48px; font-size: 0px;">
                  ...
                  <div class="outlook-group-fix" style="padding: 0 0 20px 0; vertical-align: top; display: inline-block; text-align: center; width:100%;">
                    <span style="padding: 0; font-size: 11px; line-height: 15px; font-weight: normal; color: #8B949F;">TexxeSchool<br/>Texxesoft Services Centre  India PVT Ltd. 3rd Floor,Building #2 TexxeSoft Campus, Gachibowli Hyderabad - 500032</span>
                  </div>
                    </td></tr></table>     
                </td>
              </tr>
